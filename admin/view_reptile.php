                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <td>
                                         ...
                                         <!-- edit button which retrieves the id of the particular reptile and directs to the page where the records are updated--> 
                                         <a href="edit_reptile.php?id=<?php echo $row['id'];?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                         <!-- delete button which retrieves the id of the particular reptile and leads to the confirmation -->
                                ...
                                <div class="modal fade" id="delete<?= $row['id'];?>" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <div class="col-xs-11">
                                                <!-- delete button retrieves the id and directs to the delete page of the reptile-->
                                                <a href="delete_reptile.php?deleteId=<?= $row['id'];?>" class="btn btn-danger btn-ok">Delete</a>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
